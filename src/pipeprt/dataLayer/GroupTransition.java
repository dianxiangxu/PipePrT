...
import pipeprt.gui.undo.GroupTransitionRotationEdit;
import pipeprt.gui.undo.UndoableEdit;
import pipeprt.gui.undo.UngroupTransitionEdit;
import pipeprt.gui.widgets.EscapableDialog;
import pipeprt.gui.widgets.GroupTransitionEditorPanel;
...
public class GroupTransition extends PlaceTransitionObject {
	...
	private ArrayList<PipeTransition> groupedTransitions = new ArrayList<PipeTransition>();
	
	// This is the transition that the group transition has folded into
	private PipeTransition foldedInto;
	 ...
	 *            Y-axis Position
	 */
	public GroupTransition(PipeTransition _foldedInto, double positionXInput, double positionYInput) {
	...
	public void ungroupTransitionsHelper(){
		for(PipeTransition t:groupedTransitions){
			t.unhideFromCanvas();
...
//			tempArc.removeAll();
	...
	public void addTransition(PipeTransition t){
		groupedTransitions.add(t);
	}
	public void removeTransition(PipeTransition t){
		groupedTransitions.remove(t);
	}
	public ArrayList<PipeTransition> getTransitions(){
		return groupedTransitions;
	}
	
	public void setFoldedInto(PipeTransition t){
		foldedInto = t;
	}
	public PipeTransition getFoldedInto(){
		return foldedInto;
	}
