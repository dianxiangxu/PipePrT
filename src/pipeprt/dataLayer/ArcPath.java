...
import pipeprt.gui.handler.ArcPathPointHandler;
...
public class ArcPath 
   ...
   private void setEndControlPoints() {
      ...
      if  (!(getEndIndex() > 0)) {
         return;
      } else if (source != null && source instanceof PipeTransition &&
         ...
         myPoint.setControl2(getControlPoint(myPoint.getPoint(),
                                             ...
                                             myPoint.getPoint(),
                                             myPoint.getControl1()));
      } else if (target != null && source instanceof PipePlace&&
   ...
   public double getEndAngle() {
      if (getEndIndex() > 0) {
         if (getArc().getTarget() instanceof PipeTransition) {
