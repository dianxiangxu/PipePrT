...
public class ObjectDeepCopier {
	 ...
	 * 
	 */
	public static LinkedList<PipeMarking> mediumCopy(LinkedList<PipeMarking> markings) {
		ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
		ObjectOutputStream objectOutputStream;
		LinkedList<PipeMarking> mediumCopy = null;
		try {
			objectOutputStream = new ObjectOutputStream(byteArrayOutputStream);
			...
			ObjectInputStream objectInputStream = new ObjectInputStream(
					byteArrayInputStream);
			mediumCopy = (LinkedList<PipeMarking>)objectInputStream.readObject();
